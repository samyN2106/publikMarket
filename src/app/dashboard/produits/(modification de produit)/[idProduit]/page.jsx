...
export default function MdofifProduit() {
  ...
  const onSubmit = async (data) => {
    ...
    if (imageUrl) {
      ...
      setLoading(false);
      if (erreurFile.message) console.error(erreurFile.message);
      return (
  ...
  if (produit) {
    ...
    return (
      <main className="p-[30px] w-full relative min-[1100px]:ml-64">
          ...
          <div className="w-full">
            ...
            >
              ...
              <button
                ...
                className="bg-[#9e86ba] text-white px-4 py-2 font-semibold rounded-lg hover:bg-[#9d92a8] mr-[20px]"
              >
