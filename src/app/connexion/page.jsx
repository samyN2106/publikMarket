...
export default function Connexion() {
  ...
  const [emailPwdForgot, setEmailPwdForgot] = useState("");

  // fonction pour gerer la soumission du formulaire pour mot de pass oublier
  ...
  const handlePwdForgotSubmit = async (e) => {
    ...
    const { error } = await supabase.auth.resetPasswordForEmail(
      emailPwdForgot,
      {
        redirectTo: "https://publik-market.vercel.app/update-password",
      }
    );
    ...
    <div className=" p-6 flex h-screen justify-center items-center bg-[#0000007a]">
      {pswForgot && (
        <div className="rounded-xl shadow-sm border border-gray-200 overflow-hidden bg-white w-[600px] relative">
          ...
          <form onSubmit={handlePwdForgotSubmit} className="p-[20px]">
            <div className="">
              <label
              ...
              <input
                type="email"
                onChange={(e) => setEmailPwdForgot(e.target.value)}
                value={emailPwdForgot}
